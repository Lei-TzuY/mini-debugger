...
__attribute__((noinline)) int caller_inline_crash_leaf(
  ...
  const int selected_mode_value = (int)*selected_mode;
  ...
  __asm__ volatile(
      ...
      : "r"(token + observed_value + selected_value + aggregate_direct +
            ...
            typed_aggregate_direct + typed_aggregate_mode + selected_mode_value +
  ...
  return token + observed_value + selected_value + aggregate_direct + aggregate_linked +
         ...
         typed_aggregate_mode + selected_mode_value + array_value + union_value;
}
